 ...
 * Size: 20 px
 * Bpp: 1
 * Opts: --font SplineSans/static/SplineSans-Medium.ttf --size 20 --bpp 1 --format lvgl --no-compress -r 0x20,0x25,0x43,0x48,0x52,0xB0 -o lv_font_splinesans_medium_20.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 29, .adv_w = 219, .box_w = 12, .box_h = 14, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 50, .adv_w = 219, .box_w = 10, .box_h = 14, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 68, .adv_w = 199, .box_w = 11, .box_h = 14, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 88, .adv_w = 140, .box_w = 6, .box_h = 6, .ofs_x = 1, .ofs_y = 9}
};
